...
export NUXT_APP_KIOSK_INFO_P_1="Die Inhalte stammen aus der Projekt- und Archivplattform der HfG und können dort eingesehen und detaillierter recherchiert werden. Mehr Informationen zum Studium an der HfG: https://hfg-karlsruhe.de"
...
#export NUXT_APP_USE_CACHE_FILE='/home/madek/sf_kiosk_rundgang.hfg-karlsruhe.de_tree_data.json'
#export NUXT_APP_USE_CACHE_FILE='sf_kiosk_rundgang_tree_data.json'
...
export SPATH=/home/madek/rundgang.hfg-karlsruhe.de/
export SSERVICE=rundgang.hfg-karlsruhe.de
