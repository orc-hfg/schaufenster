<template>
    ...
    <div class="dialog_ds" data-theme="dark">
        <header>
            <nav class="nav">
...
<!--
            ...
            <div class="row_100">
                <div class="col_50">
                    <div class="ds_list">
                        <div class="ds_list_title">
                            Projektleitung
                        </div>
                        <div class="ds_list_content_wrap">
                            <div class="ds_list_content">
                                Dr. Barbara Kuon
                            </div>
                            <div class="ds_list_content_link">
                    ...
                    <div class="ds_list">
                        ...
                        <div class="ds_list_content_wrap2">
                            <div class="ds_list_content_wrap">
                                <div class="ds_list_content">
                                    Hannes Herold 
                                </div>
