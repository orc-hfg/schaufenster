...
#export NUXT_APP_USE_CACHE_FILE='/home/madek/sf_kiosk_rundgang_tree_data.json'
...
export SPATH=/home/madek/sf_kiosk_rundgang/
export SSERVICE=madek.sf_kiosk_rundgang
