...
npm run build
rsync -avz .output alex@madek.hfg-karlsruhe.de:/home/madek/sf_kiosk_rundgang/
ssh alex@madek.hfg-karlsruhe.de "sudo systemctl restart madek.sf_kiosk_rundgang"
